...
will be handled by my utils library. Separating this code will keep things cleaner, I think, and
easier to understand the flow of my application. This may not be advised in a real
world situation. I don't know enough to tell for sure. This should help me understand
better how to go about building a large-scale application though, even with another
...
(function (global) {
	...
	//Glass.init-type object. The point of the arguments is to have properties we can use to get
